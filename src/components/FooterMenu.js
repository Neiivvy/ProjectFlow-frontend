"use client";
import { PROJECT_LIST_ROUTE } from "@/constants/route";
      ...
      <div className="mx-auto w-full max-w-7xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            <span className="pt-2">PMS (Project Management System)</span>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              <h2 className="mb-6 text-xl font-bold text-heading uppercase">
                Resources
              </h2>
              <ul className="text-body font-medium space-y-2 cursor-pointer ">
                <li className="hover:underline">Documentation</li>
                <li className="hover:underline">Community Form</li>
